 ...
 * @author ACER
 */
public class Anak extends javax.swing.JFrame {

    /**
     * Creates new form Anak
     */
    public Anak() {
        initComponents();
        kosong();
...
try { // tombol tambah
String sql = "INSERT INTO anak (id, nama, jenkel, telepon, harga) VALUES ('"
                    + idTF.getText() + "', '"
                    + namaTF.getText() + "', '"
    ...
    try { // tombol ubah
    String sql = "UPDATE anak SET id = ?, nama = ?, jenkel = ?, telepon = ?, harga = ?";
...
kosong();
    ...
    try { // tombol hapus
            String sql ="delete from anak where id='"+idTF.getText()+"'";
            java.sql.Connection conn=(Connection)koneksi.configDB();
            java.sql.PreparedStatement pst=conn.prepareStatement(sql);
            pst.execute();
   ...
   try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Anak.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
